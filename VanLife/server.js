...
createServer({
    ...
    seeds(server) {
        ...
        server.create("user", { id: "123", email: "kingz@vl.com", password: "p123", name: "Kingz" })
    },
    ...
    routes() {
        ...
        this.post("/login", (schema, request) => {
            ...
            if (!foundUser) {
                return new Response(401, {}, { message: "No user with those credentials found! Login with kingz@vl.com and p123" })
            }
