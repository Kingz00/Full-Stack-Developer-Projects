...
export const projects: Project[] = [
    ...
    },
    {
        ...
        image: "/projects/vanlife-hero-section-v2_0.png",
        technologies: [
            "React",
            "React Router",
            "JavaScript",
        ...
        highlights: [
            "Firebase as the application's single source of truth",
            "Firebase Authentication",
            "Firestore security rules",
            "React Router data APIs",
            "Protected and nested routes",
            "Route loaders and actions",
            "Responsive UI and application feedback states",
        ],
        technicalDetails: {
        ...
        screenshots: [
            {
                src: "/projects/vanlife-hero-section-v2_0.png",
                alt: "VanLife customer landing page",
                caption: "The customer-facing landing page for discovering and browsing available vans.",
            },
            {
                src: "/projects/vanlife-individual-van-v2.png",
                alt: "VanLife van details page",
                caption: "A dynamic van details page displaying vehicle information, pricing, and rental options.",
            },
            {
                src: "/projects/vanlife-host-dashboard-v2.png",
                alt: "VanLife host dashboard",
                caption: "The protected host dashboard for managing van listings and viewing host-specific information.",
            },
        ],
        githubUrl:
